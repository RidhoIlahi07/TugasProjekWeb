...
<table>
	...
	<section>
		<article class="article">
			<div class="judul_data"><b>DATA PEGAWAI</b></div>
			<br>
			<a href="tambah-pegawai.php" class="tombol_daftar">Tambah Pegawai</a>
			<table class="table1">
				<tr>
					<th>No</th>
					<th>Username</th>
				...
				<?php if(mysqli_num_rows($query)>0){
					...
					while($data = mysqli_fetch_array($query)){
						...
						<tr>
							...
							<td>
								<a class="red" href="../../controler/hapus-pegawai.php?id=<?php echo $data['id_pegawai']; ?>">HAPUS</a> |
								<a class="blue" href="update-pegawai-form.php?id=<?php echo $data['id_pegawai']; ?>">Update</a>
							</td>
						</tr>
						<?php $no++; } ?>
					<?php } ?>
